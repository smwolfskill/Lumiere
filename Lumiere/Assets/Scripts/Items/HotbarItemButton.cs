...
public class HotbarItemButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public HotbarPanel panelScript;
    ...
    public void SetGUIReferences(HotbarPanel panelScript)
    {
